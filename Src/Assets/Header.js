    ...
    <View>
      <View style={styles.header}>
        ...
        <TouchableOpacity
          ...
          <Text style={{color:Colours.TextDarkColour, fontSize: 16, fontFamily: Family.Medium}}>
          <Search name="search-outline" size={23} color={Colours.PrimaryColor} />
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() => {
          ...
          <Text style={{color:Colours.TextDarkColour, fontSize: 14, fontFamily: Family.Medium}}>
